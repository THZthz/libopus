...
(function (mod) {
    ...
    CodeMirror.defineMode("javascript", function (config, parserConfig) {
        ...
        function parseJS(state, style, type, tag_list, stream) {
            var cc = state.cc;
            ...
            while (true) {
                ...
                if (combinator(type, tag_list)) {
                    while (cc.length && cc[cc.length - 1].lex)
                        cc.pop()();
                    if (cx.marked) return cx.marked;
                    if (type == "variable" && inScope(state, tag_list)) return "variable-2";
                    return style;
                }
            }
        }
        ...
        return {
            ...
            token: function (stream, state) {
                ...
                state.lastType = type == "operator" && (tag_list == "++" || tag_list == "--") ? "incdec" : type;
                return parseJS(state, style, type, tag_list, stream);
            },
