/*
    ...
    OpenGL loader generated by glad 0.1.34 on Thu Nov 18 22:51:23 2021.
...
static int get_exts(void) {
	...
	if (max_loaded_major < 3) {
		...
		for (index = 0; index < (unsigned) num_exts_i; index++) {
			...
			size_t __count = strlen(gl_str_tmp);

			char *local_str = (char *) malloc((__count + 1) * sizeof(char));
			if (local_str != NULL) {
				memcpy(local_str, gl_str_tmp, (__count + 1) * sizeof(char));
			}
...
#else
	sscanf(version, "%data.%data", &major, &minor);
#endif
